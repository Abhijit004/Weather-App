        ...
        case "01d":
            return (
                <g transform="translate(32,32)">
                    ...
                    <circle cx="0" cy="0" fill="yellow" r="5" stroke="yellow" strokeWidth="2" />
                </g>
            );
        case "01n":
            return (
        ...
        case "10n":
            return (
                <g transform="translate(20,10)">
                    ...
                    <g transform="translate(12,36), rotate(10)">
                        <line
                            className="am-weather-rain-1"
                            fill="none"
                            stroke="#ffffff60"
        ...
        case "11n":
            return (
                <g transform="translate(20,5)">
                    ...
                    <g transform="translate(9,36), rotate(10)">
                        <line
                            className="am-weather-rain-1"
                            fill="none"
                            stroke="#ffffff60"
        ...
        case "50d":
            return (
                <>
                    ...
                    <g transform="translate(41,45), rotate(90)">
                        <line
                            className="am-weather-rain-1"
                            fill="none"
                            stroke="#ffffff60"
        ...
        case "50n":
            return (
                <g transform="translate(20,10)">
                    ...
                    <g transform="translate(22,35), rotate(90)">
                        <line
                            className="am-weather-rain-1"
                            fill="none"
                            stroke="#ffffff60"
